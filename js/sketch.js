...
var convertStringToInt = function(numb) {
	for (var i = -600; i <= 600; i += 1) {
		// Goes through every number from -600 to 600
		if (numb === "" + i) {
	...
	for (var i = 0; i < fish.length; i++) {
		...
		append(
			...
			id +
				...
				"|" +
				speed
		); // Saves the fish but changes the x value to move the fish
	}
